...
export default function ResumenProducto({producto}) {
    ...
    const { handleEditarCantidad, handleEliminarProductoPedido } = useDrinks()
    ...
    return (
        <div className="shadow space-y-1 p-4 bg-white">
            ...
            <button
                ...
                type="button"
                className="bg-sky-500 p-2 text-white rounded-md font-bold uppercase shadow-md text-center"
            >
                <svg
            ...
            <button
                ...
                type="button"
                className="bg-red-500 p-2 text-white rounded-md font-bold uppercase shadow-md text-center"
            >
                <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
